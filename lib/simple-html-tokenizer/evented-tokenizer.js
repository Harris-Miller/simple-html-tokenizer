  ...
  states: {
    ...
    beforeAttributeValue: function() {
      ...
      if (isSpace(char)) {
        ...
        this.state = 'possibleAttributeValueUnquotedExp';
      } else {
    ...
    beforeNextAttributeValueDoubleQuoted: function() {
      var char = this.peek();
    ...
    beforeNextAttributeValueSingleQuoted: function() {
      var char = this.peek();
    ...
    attributeValueDoubleQuoted: function() {
      ...
      if (isSpace(char)) {
        this.delegate.beginNextAttributeValue();
        this.state = 'beforeNextAttributeValueDoubleQuoted';
      } else if (char === '"') {
        this.delegate.finishAttributeValue();
        this.state = 'afterAttributeValueQuoted';
      } else if (char === "&") {
    ...
    attributeValueSingleQuoted: function() {
      ...
      if (isSpace(char)) {
        this.delegate.beginNextAttributeValue();
        this.state = 'beforeNextAttributeValueSingleQuoted';
      } else if (char === "'") {
        this.delegate.finishAttributeValue();
        this.state = 'afterAttributeValueQuoted';
      } else if (char === "&") {
    ...
    possibleAttributeValueUnquotedExp: function() {
      var char = this.consume();

      if (char === "{") {
        this.state = 'attributeValueUnquotedExpName';
        this.delegate.beginAttributeValue(false);
        this.delegate.beginAttributeValueExp();
      } else {
        this.state = 'attributeValueUnquoted';
        this.delegate.beginAttributeValue(false);
    ...
    attributeValueUnquotedExpName: function() {
      var char = this.consume();

      if (char === "}") {
        this.state = 'possibleAttributeValueUnquotedExpEnd';
      } else if(isSpace(char)) {
        this.state = 'beforeAttributeValueUnquotedExpAttrName';
      } else {
        this.delegate.appendToAttributeValueExpName(char);
      }
    },

    beforeAttributeValueUnquotedExpAttrName: function() {
      var char = this.consume();
      ...
      if (isSpace(char)) {
        ...
        this.state = 'attributeValueUnquotedExpAttrName';
      }
    },

    attributeValueUnquotedExpAttrName: function() {
      var char = this.consume();
      ...
      if (isSpace(char)) {
        ...
        this.delegate.appendToAttributeValueExpAttrName(char);
      }
    },

    possibleAttributeValueUnquotedExpEnd: function() {
      var char = this.consume();
